...
<body onload="loadcount()">
    ...
    <div class="card shadow card card border-shadow">
      <div class="row">
          ...
          <div class="slider" id="slidergal">
            <div class="slides" id="slidersgal">
              ...
              <div class="slidefirst" id="slidefirst">
                <img src="upload/UI/01.jpg" alt="">
              </div>
              <div class="slide">
                <img src="upload/UI/02.jpg" alt="">
              </div>
              <div class="slide">
                <img src="upload/UI/03.jpg" alt="">
              </div>
              <div class="slide">
                <img src="upload/UI/04.jpg" alt="">
              </div>
        ...
        <div class="col-3 align-self-center">
          <h3 id="dup1" class="card-title-center">Welcome to Our Company</h3>
          <h5 id="dup" class="card-text">
            Design your place with our Team and we will make true your Dream place
          </h5>
  ...
  <div class="container-fluid px-0 py-2">
   <div class="card" id="indexproducttitel1" style="width:150px">
   <h4 class="px-2">Service</h4>
   </div>
</div> 
<div class="container">
    <div class="row text-center py-5" id="servicers">
      <!-- service listed Area -->
