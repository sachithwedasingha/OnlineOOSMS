...
//this function to make new service order
public function makeservice($tempid,$userid,$date,$address,$serviceid,$designid,$unitprice,$width,$height,$total){
   //chek temp id is avalabale in the db?
   $result = "SELECT * FROM order_service_tbl WHERE temp_id = $tempid AND d_status = 0;";
    ...
    $sqlResult = $this->dbResult->query($result);
     ...
     if($nor > 0){
                ...
                $autonumber = new AutoNumber;
                $meshid = $autonumber -> NumberGeneration("mesh_Id","service_mesh_tbl","MES");

                //insert data to table
                $sqlInsert = "INSERT INTO service_mesh_tbl VALUES('$meshid','$osid','$designid','$unitprice','$width','$height',0);";
              ...
              //ganaratr new id to status tbl
              $autonumber = new AutoNumber;
              $statusid = $autonumber -> NumberGeneration("status_Id","service_status_tbl","STA");
              //ganaratr new id to order service table
              $autonumber = new AutoNumber;
              $osid = $autonumber -> NumberGeneration("os_Id","order_service_tbl","OSE");
         
               //insert data to status table
               $sqlInsert = "INSERT INTO service_status_tbl VALUES('$statusid',1,1,0,0,0,0,0,0);";
             ...
             //insert data to os table
             $sqlInsert1 = "INSERT INTO order_service_tbl VALUES('$osid','$tempid','$userid','$statusid','$address','$date','$total','$serviceid',0);";
             ...
             if($sqlResult > 0){
                            ...
                            //insert data to  meshurment table
                            $sqlInsert = "INSERT INTO service_mesh_tbl VALUES('$meshid','$osid','$designid','$unitprice','$width','$height',0);";
...
//this function to make new service order
public function makeserviceoff($tempid,$userid,$date,$address,$serviceid,$designid,$unitprice,$width,$height,$total){
  //chek temp id is avalabale in the db?
  $result = "SELECT * FROM order_service_tbl WHERE temp_id = $tempid AND d_status = 0;";
   ...
   $sqlResult = $this->dbResult->query($result);
    ...
    if($nor > 0){
             ...
             $osid = $autonumber -> NumberGeneration("os_Id","order_service_tbl","OSE");
              ...
              //insert data to status table
              $sqlInsert = "INSERT INTO service_status_tbl VALUES('$statusid',1,0,0,0,0,0,0,0);";
