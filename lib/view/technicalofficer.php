...
<head>
  <title>
    <Table>TEESHAN iNTERIOR DESIGNERS Admin</Table>
  </title>
</head>
    ...
    <nav id="sidebar" class="sidebar-wrapper">
      <div class="sidebar-content">
        <div class="sidebar-brand">
          <a href="" #style="color:red">TEESHAN INTERIOR</a>
          ...
          <ul>
            ...
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  <li>
                    <a href="#" id="add_service">Add Service</a>
                  </li>
                  <li>
                    <a href="#" id="add_service_design">Add Service Design</a>
                  </li>
                  <!-- <li>
                    <a href="#">Edit Service</a>
                  </li>
                  <li>
                    <a href="#">Edit Design</a>
                  </li> -->
                </ul>
              </div>
            </li>
            ...
            <li class="sidebar-dropdown">
              <a href="#">
              <i class="fas fa-paint-roller"></i>
                <span>Manage Service Orders</span>
              </a>
              <div class="sidebar-submenu">
                <ul>
                  <!-- <li>
                    <a href="#" id="sviewallorders">All Service Orders</a>
                  </li> -->
                  <li>
                    <a href="#" id="sdeliveryifo">State Information</a>
                  </li>
                  <!-- <li>
                    <a href="#" id="sofflinepay">Offline Payment</a>
                  </li> -->
                  <li>
                    <a href="#" id="sordercontamation">Service Confamation</a>
                  </li>
                  <li>
                    <a href="#" id="sstorrady">Rady to Tranport</a>
                  </li>
                  <li>
                    <a href="#" id="sdeliverd">Service Finished</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="sidebar-dropdown">
              ...
              <div class="sidebar-submenu">
                <ul>
                  ...
                  <li>
                    <a href="invoice/income selected time periods.php">Service Income (selected time)</a>
                  </li>
                  <li>
                    <a href="invoice/order report.php">Order Report</a>
                  </li> -->
                  <li>
                    <a href="invoice/progress report.php">progress Report</a>
                  </li>
                  <!-- <li>
        ...
        <div class="container-fluid">
          ...
          <div class="col-2" id="navbarColor02">
            <ul class="navbar-nav me-auto">
              ...
              <!-- <button type="button" class="btn btn-link"><i class="far fa-bell" style="color:#F36347"></i></button>
              <button type="button" class="btn btn-link"><i class="far fa-comment"  style="color:#FCF21E"></i></button> -->
