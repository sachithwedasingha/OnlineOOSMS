<div class="card border-light">
    <div class="card-body">
        <div class="row">
            <div class="col-6">
                <h5>Service Order confirmation</h5>
            </div>
            <siv class="col-6">
...
<script>
    $(document).ready(function(){
        ...
        $.get("../routes/order_service/order_confrm.php", function (res) {
        //display data 
        $("#pro_list").html(res);
        })
        ...
        $("#search_product").on('input',function(){
            ...
            $.get("../routes/order_service/order_confrm_serch.php",{searchData:$inputData},function(res){
                $("#pro_list").html(res);
            })
        })
    ...
    function conferm(oid){
        ...
        {
            $.get("../routes/order_service/conferm.php",{
                oid:oid
            },function (res) {
                if(res="ok"){
            Swal.fire(
    ...
    function declare(oid){
        ...
        if (result.isConfirmed) 
        {
            $.get("../routes/order_service/order_declare.php",{
                oid:oid
            },function (res) {
                if(res="ok"){
