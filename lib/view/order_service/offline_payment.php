...
<script>
    $(document).ready(function(){
        ...
        $.get("../routes/order_service/offlinepay.php", function (res) {
        //display data 
        $("#pro_list").html(res);
        })
        ...
        $("#search_product").on('input',function(){
            ...
            $.get("../routes/order_service/offlinepayserch.php",{searchData:$inputData},function(res){
                $("#pro_list").html(res);
            })
        })
    ...
    function offlinepay(oid){
        ...
        if (result.isConfirmed) 
        {
            $.get("../routes/order_service/pay_offline.php",{
                oid:oid
            },function (res) {
                if(res="ok"){
            Swal.fire(
