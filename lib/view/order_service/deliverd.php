...
<script>
    $(document).ready(function(){
        ...
        $.get("../routes/order_service/order_deliverd.php", function (res) {
        //display data 
        $("#pro_list").html(res);
        })
        ...
        $("#search_product").on('input',function(){
            ...
            $.get("../routes/order_service/order_deliverd_serch.php",{searchData:$inputData},function(res){
                $("#pro_list").html(res);
            })
        })
    ...
    function deliverd(oid){
        ...
        {
            $.get("../routes/order_service/deliverd.php",{
                oid:oid
            },function (res) {
                if(res="ok"){
            Swal.fire(
