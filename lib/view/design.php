...
<div class="container-fluid" style="display: flex; flex-direction: row;">
    ...
    <div class="col-10 px-2" style=" display: block;    height: 590px; overflow-y: scroll;" id="details">
      ...
      <div class="card border-secondary mb-3 mt-2" id="emptyser" style="max-width: 70rem; max-height: 200rem;">
        <div class="card-body">
        <img src="../upload/ui/01.png" width="200px" style="display: block; margin-left: auto; margin-right: auto; margin-top:100px; margin-bottom:20px;" alt="">
          <h4 class="card-title" style="text-align:center;  margin-bottom:100px;">Select Service to get more Details</h4>
        </div>
      </div>

      <div class="card border-secondary mb-3 mt-2" id="emptydes" style="max-width: 70rem; max-height: 200rem;">
        <div class="card-body">
        <img src="../upload/ui/01.png" width="200px" style="display: block; margin-left: auto; margin-right: auto; margin-top:100px; margin-bottom:20px;" alt="">
          <h4 class="card-title" style="text-align:center;  margin-bottom:100px;">Select Design to get more Details</h4>
        </div>
      </div>
