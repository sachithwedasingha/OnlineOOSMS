$(document).ready(function(){
   ...
   $('#add_service_design').click(function(){
    ...
    $('#sviewallorders').click(function(){
      $('#adminloadContent').load('order_service/view_all_Orders.php');
    });
    
    $('#sdeliveryifo').click(function(){
      $('#adminloadContent').load('order_service/deliveryinfo.php');
    });
  
    $('#sofflinepay').click(function(){
      $('#adminloadContent').load('order_service/offline_payment.php');
    });

    $('#sordercontamation').click(function(){
      $('#adminloadContent').load('order_service/order_conform.php');
    });

    $('#sstorrady').click(function(){
      $('#adminloadContent').load('order_service/Rady_to_transport.php');
    });

    $('#sdeliverd').click(function(){
      $('#adminloadContent').load('order_service/deliverd.php');
    });
